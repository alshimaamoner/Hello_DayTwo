 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9090/ws/HelloService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9090/ws/HelloService?wsdl");
    ...
    public HelloImpl getHelloImplPort() {
        return super.getPort(new QName("http://service/", "HelloImplPort"), HelloImpl.class);
    }
    ...
    public HelloImpl getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "HelloImplPort"), HelloImpl.class, features);
    }
